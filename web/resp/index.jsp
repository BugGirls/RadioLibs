...
<header class="am-topbar am-topbar-inverse admin-header">
    <div class="am-topbar-brand">
        <strong><span>河南人民广播电台</span> 媒体资源库</strong>
        <small>后台管理</small>
    </div>
        ...
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            <ul class="am-list admin-sidebar-list setbg">
                ...
                <li class="admin-parent">
                    <a class="am-cf" data-am-collapse="{target: '#collapse-nav2'}"><span class="am-icon-tasks"></span> 设置<span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
                        <li><a href="tag_group_list.xhtml" target="mainIframe"><span class="am-icon-tags"></span> 标签组管理</a></li>
                        <li><a href="permission_list.xhtml" target="mainIframe"><span class="am-icon-bank"></span> 权限管理</a></li>
                        <li><a href="role_list.xhtml" target="mainIframe"><span class="am-icon-mortar-board"></span> 角色管理</a></li>
                        <li><a href="manager_group_list.xhtml" target="mainIframe">&nbsp;<span class="am-icon-users"></span> 用户组管理</a></li>
                        <li><a href="manager_list.xhtml" target="mainIframe">&nbsp;<span class="am-icon-user"></span> &nbsp;用户管理</a></li>
                    </ul>
                    <a class="am-cf" data-am-collapse="{target: '#collapse-nav1'}"><span class="am-icon-product-hunt"></span> 资源库管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
...
<footer class="admin-content-footer">
    <hr>
    <p class="am-padding-left">© 2018 hndt.com, Inc. Licensed under MIT license.</p>
</footer>
...
<script>
    $(function() {
        ...
        console.log($('ul.setbg li').find('ul').children())
