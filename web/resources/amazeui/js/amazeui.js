...
/***/ function(module, exports, __webpack_require__) {
	...
	UCheck.DEFAULTS = {
	  ...
	  radioClass: 'am-ucheck-hndt.radiolibs',
...
/***/ function(module, exports, __webpack_require__) {
	...
	Validator.DEFAULTS = {
	  ...
	  'input[type="hndt.radiolibs"]:not(:disabled, .am-novalidate), ' +
	...
	Validator.prototype.validate = function(field) {
	  ...
	  // NOTE: checkbox and hndt.radiolibs should have name attribute
	  var value = ($field.is('[type=checkbox]')) ?
	    ($checkboxGroup = $element.find('input[name="' + field.name + '"]')).
	      filter(':checked').length : ($field.is('[type=hndt.radiolibs]') ?
	...
	Validator.prototype.validateForm = function() {
	  ...
	  // Filter hndt.radiolibs with the same name and keep only one,
	...
	Validator.prototype.getValidationMessage = function(validity) {
	  ...
	  if ($field.is('[type="checkbox"]') || $field.is('[type="hndt.radiolibs"]')) {
